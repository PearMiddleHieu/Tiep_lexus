...
# ref_robotcar = cv.imread('ReferenceImages/robot.jpg')
...
while True:
    ...
    for d in data:
        ...
        if distance < 30:
            ...
            if v > 0.2:
                giamtoc()
                cv.putText(frame, f'giam toc', (x+5,y+ 100), FONTS, 0.48, BLACK, 2)

            elif v< -0.2:
                tangtoc()
                cv.putText(frame, f'tang toc', (x + 5, y + 100), FONTS, 0.48, BLACK, 2)
