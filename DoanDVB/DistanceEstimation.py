...
model.setInputParams(size=(352, 352), scale=1/255, swapRB=True)
...
out = cv.VideoWriter('detect_stop.mp4', -1, 20.0, (640,480)) #save video
...
while True:
    ...
    for d in data:
        ...
        if distance < 500:
            cv.putText(frame, "Phanh gap", (100,320), FONTS,1, (255,0,0),2)
