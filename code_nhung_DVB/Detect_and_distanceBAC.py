...
yoloNet = cv.dnn.readNet('yolov4-tiny-custom_v4_96_last.weights', 'yolov4-tiny-custom_v4_96.cfg')

#yoloNet.setPreferableBackend(cv.dnn.DNN_BACKEND_CUDA)
#yoloNet.setPreferableTarget(cv.dnn.DNN_TARGET_CUDA_FP16)
model = cv.dnn_DetectionModel(yoloNet)
model.setInputParams(size=(128,96), scale=1/255, swapRB=True)
...
#    print (h, w)
    ...
    for d in data:
        ...
        #data = (str(distance)) + " " + (str(dt_string))+':'+ milli_second + "  "+(str(line)) + "\n"
        #print(data)
